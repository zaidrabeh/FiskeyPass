// =============================================================================
// WebPortal.h — FiskeyPass v3.0.1 Dark-Themed Web Dashboard (PROGMEM)
// =============================================================================
//
...
<div class="ver">v3.0.1 &middot; Secure Portal</div>
</div>
...
<input type="password" id="pin-old" placeholder="Enter current 4-digit PIN" maxlength="4">
<label>New PIN</label>
<input type="password" id="pin-new" placeholder="Enter new 4-digit PIN" maxlength="4">
<label>Confirm New PIN</label>
<input type="password" id="pin-conf" placeholder="Repeat new PIN" maxlength="4">
<div class="actions">
...
<input type="password" id="pin-unlock" placeholder="----" maxlength="4"
...
function doUnlock(){
  ...
  if(pin.length!==4||!/^\d{4}$/.test(pin)){err.textContent='PIN must be exactly 4 digits';return;}
  err.textContent='';
...
function changePin(){
  ...
  if(o.length!==4||n.length!==4){toast('PIN must be 4 digits',false);return;}
